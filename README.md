...
- Tools come in three kinds: **built-in** (a Light Church page, e.g. Game Builder and Mission/Camp Companion — where ministry leaders plan a trip or camp's schedule, devotionals, songs, photos and notes for the whole team), **hosted** (a ready-made app that runs inside Light Church in a locked-down sandbox, e.g. Roll Call and Sunday Service Bulletin) and **external links** (open in a new tab, with a reminder not to paste members' personal data, e.g. Finance Pipeline).
