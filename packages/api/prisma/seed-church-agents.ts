/**
 * Seeds the Church Ministries pack's worker agents into Clawix.
 * Run via: node scripts/seed-church-agents.mjs  (from repo root)
 *
 * Agent definitions live in ../src/packs/definitions/church-agents.data.ts — the
 * single source of truth also used by the Ministry Packs settings tab / API.
 */
import dotenv from 'dotenv';
import path from 'node:path';
import { PrismaPg } from '@prisma/adapter-pg';
import { PrismaClient } from '../src/generated/prisma/client.js';
import { CHURCH_AGENTS } from '../src/packs/definitions/church-agents.data.js';
