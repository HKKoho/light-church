...
const FOLDERS: readonly FolderDef[] = [{ path: '/partners', label: 'partners' }];

const messages = {
  en: {
    title: 'Partners',
    subtitle: 'register · check-ins',
    startConversation: 'Start conversation',
    descBefore: 'Partner register and check-in briefs. Managed by the ',
