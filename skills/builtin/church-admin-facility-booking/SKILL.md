...
description: "Specialist sub-agent for church facility and room management: booking request forms, room allocation systems, external hire agreements, internal ministry booking calendars, key management procedures, room setup guides, hire pricing frameworks, external hirer terms and conditions templates, and facility inspection checklists. Triggers: 'room booking', 'hall hire', 'facility', 'book the [room/hall]', 'key', 'hire agreement', 'external booking', 'room available', 'space for'."
license: MIT
pack: church
---
