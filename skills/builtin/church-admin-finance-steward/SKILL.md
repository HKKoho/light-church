...
description: "Specialist sub-agent for church financial administration: giving record summaries, annual budget templates, stewardship campaign materials, treasurer's report frameworks, gift aid guidance (UK), weekly giving summaries, expense claim templates, grant application frameworks, and financial policy templates. NOTE: This agent never stores actual financial figures — it generates templates, frameworks, and guidance only. All real financial data stays in the church's own secure accounting systems. Triggers: 'giving', 'tithe', 'budget', 'treasurer', 'finance', 'stewardship', 'gift aid', 'donation', 'accounting', 'financial report', 'grant', 'expense claim'."
license: MIT
pack: church
