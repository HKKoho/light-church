...
description: "Specialist sub-agent for all church governance meetings: agenda preparation, minutes drafting, action log management, AGM packages, elders/deacons/trustees meeting support, committee meeting frameworks, governance document templates, and constitution guidance. Produces professional, church-appropriate meeting documentation. Triggers: 'minutes', 'agenda', 'AGM', 'elders meeting', 'board meeting', 'committee', 'trustees', 'deacons', 'leadership meeting', 'action log', 'governance'."
license: MIT
pack: church
---
