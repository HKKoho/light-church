---
name: church-admin
description: "Use this skill for ALL church administration tasks: event planning, bulletin creation, newsletter drafting, volunteer scheduling, meeting agendas, church calendar management, announcement writing, membership communication, policy templates, and financial stewardship summaries. Also handles: AGM preparation, committee meeting notes, rotas, room booking templates, and visitor follow-up workflows. Triggers: 'bulletin', 'newsletter', 'event', 'schedule', 'volunteer', 'rota', 'agenda', 'announcement', 'admin', 'calendar', 'AGM', 'church meeting', 'membership'."
license: MIT
pack: church
---
